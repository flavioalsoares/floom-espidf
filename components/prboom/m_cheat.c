...
static void cheat_mus(void *arg);
static void cheat_choppers(void *arg);
static void cheat_god(void *arg);
static void cheat_fa(void *arg);
static void cheat_k(void *arg);
static void cheat_kfa(void *arg);
static void cheat_noclip(void *arg);
static void cheat_pw(void *arg);
static void cheat_behold(void *arg);
static void cheat_clev(void *arg);
static void cheat_mypos(void *arg);
static void cheat_rate(void *arg);
static void cheat_comp(void *arg);
static void cheat_friction(void *arg);
static void cheat_pushers(void *arg);
static void cheat_tnttran(void *arg);
static void cheat_massacre(void *arg);
static void cheat_ddt(void *arg);
static void cheat_hom(void *arg);
static void cheat_fast(void *arg);
static void cheat_tntkey(void *arg);
static void cheat_tntkeyx(void *arg);
static void cheat_tntkeyxx(void *arg);
static void cheat_tntweap(void *arg);
static void cheat_tntweapx(void *arg);
static void cheat_tntammo(void *arg);
static void cheat_tntammox(void *arg);
static void cheat_smart(void *arg);
static void cheat_pitch(void *arg);
static void cheat_megaarmour(void *arg);
static void cheat_health(void *arg);
...
static void cheat_massacre(void *arg)    // jff 2/01/98 kill all monsters
{
...
static void cheat_tntweapx(void *arg)
{
  ...
  if (w==wp_fist)           // make '1' apply beserker strength toggle
    cheat_pw((void*)(intptr_t)pw_strength);
  else
    if (w >= 0 && w < NUMWEAPONS) {
        ...
        if (!matchedbefore)               // allow only one cheat at a time
          {
            ...
            cheat[i].func((void*)(intptr_t)cheat[i].arg);  // call cheat handler
          }
    }
  return ret;
}
